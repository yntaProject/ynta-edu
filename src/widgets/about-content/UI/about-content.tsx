  ...
  return (
    <div>
      ...
      <animated.div style={animationY} className={cl.aboutContent}>
        ...
        <div className={cl.aboutContentItem}>
          <h3>Достижения</h3>
          <p>Мы регулярно расширяем нашу библиотеку, учитывая пожелания и предложения наших пользователей.
            Наши активные читатели помогут создать уникальное и живое сообщество любителей книг.</p>
        </div>
        <div className={cl.aboutContentItem}>
          <h3>Авторы</h3>
